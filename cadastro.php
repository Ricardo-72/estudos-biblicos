      ...
      <article>
        <h1>Cadastre-se aqui:</h1>
          <form action="processa.php" method="POST" autocomplete="on">
            ...
            <input type="text" id="cargo" name="us_cargo" required maxlength="50" placeholder="Cargo que ocupa na igreja">
            <span></span>
            <div>
              <label for="us_igreja" class="igreja">Igreja:</label>
              <input type="text" id="igreja" name="us_igreja" required maxlength="100" placeholder="Nome da igreja que Congrega">
              <span></span>
            </div>
            <div>
